...
export default function TecnologiaCard({ title, image, index }: TecnologiaCardProps) {
  return (
    <Link href={`/tecnologias/${index}`}>
      <div className="w-52 h-60 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-shadow duration-300 p-6 m-4 flex flex-col items-center justify-between cursor-pointer border border-gray-200 dark:border-gray-700 hover:border-blue-500">
